...
module.exports.routes = {
  ...
  'get /appconfig/:appName':'AppConfigController.getConfig',
  'get /appconfig':'AppConfigController.getConfig',

  'get /':'AppDesignController.getIndex',
  'get /app/:appName':'AppDesignController.getIndex',
  'get /app/:appName/*':'AppDesignController.getIndex',
  
  'get /design/':'AppDesignController.getIndex',
  'get /design/:appName':'AppDesignController.getIndex',
  'get /design/:appName/*':'AppDesignController.getIndex',
  // {
  //   // skipAssets: true,
  //   target:'/index.html'
  ...
  // '/log':"LogController.subscribe",
  // '/logscribe':"LogController.unsubscribe",
